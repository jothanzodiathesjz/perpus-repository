...
Route::post('/auth/register/mahasiswa/store',[AuthController::class, 'RegisterMahasiswaStore'])->name('mahasiswa.store');
Route::post('/auth/register/alumni/store',[AuthController::class, 'RegisterAlumniStore'])->name('alumni.store');
Route::post('/auth/register/dosen/store',[AuthController::class, 'RegisterDosenStore'])->name('dosen.store');


// login
Route::post('/login/store',[AuthController::class, 'LoginStore'])->name('login.store');
Route::post('/login/admin/store',[AuthController::class, 'adminLogin'])->name('login.admin.store');
