...
<!-- E-commerce Search Bar Ends -->
  ...
  <div class="col-12">
    <div class="card invoice-preview-card">
      <div class="card-body">
        <h3 id="buletin-title">Buletin Teknik Informatika: Recent Submssion</h3>
...
const url = '/api/skbp1/getvolume?prodi=nformatika&type=Jurnal';
...
getVolume()
        ...
        function getListFromVolume(volume,paginate){
          ...
          let url;
          if(volume){
            url ='/api/skbp1/getList?vol='+volume+'&prodi=Teknik Informatika&type=jurnal';
          }else if(paginate){
            url =paginate;
          }else{
            url ='/api/skbp1/getList?prodi=Teknik Informatika&type=jurnal';
          }
...
function searchJurnal(search){
  fetch(`/api/skbp1/search?prodi=Teknik Informatika&type=Jurnal&search=${search}`)
