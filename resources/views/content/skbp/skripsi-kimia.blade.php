...
const url = '/api/skbp1/getvolume?prodi=Teknik Kimia';
...
getVolume()
        ...
        function getListFromVolume(volume,paginate){
          ...
          let url;
          if(volume){
            url ='/api/skbp1/getList?vol='+volume+'&prodi=Teknik Kimia&type=Skripsi';
          }else if(paginate){
            url =paginate;
          }else{
            url ='/api/skbp1/getList?prodi=Teknik Kimia&type=Skripsi';
          }
...
function searchJurnal(search){
  fetch(`/api/skbp1/search?prodi=Teknik Kimia&type=Skripsi&search=${search}`)
