...
const url = '/api/skbp1/getvolume?prodi=Teknik Informatika&type=Skripsi';
...
getVolume()
        ...
        function getListFromVolume(volume,paginate){
          ...
          if(volume){
            ...
            url ='/api/skbp1/getList?prodi=Teknik Informatika&type=Skripsi';
          }
...
function searchJurnal(search){
  fetch(`/api/skbp1/search?prodi=Teknik Informatika&type=Skripsi&search=${search}`)
