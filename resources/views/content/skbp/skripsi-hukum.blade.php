...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Dashboard/</span> Skbp1 / Skripsi
</h4>
...
<!-- E-commerce Search Bar Ends -->
  ...
  <div class="col-12">
    <div class="card invoice-preview-card">
      <div class="card-body">
        <h3 id="buletin-title">Skripsi Hukum: Recent Submssion</h3>
...
const url = '/api/skbp1/getvolume?prodi=hukum&type=Skripsi';
...
getVolume()
        ...
        function getListFromVolume(volume,paginate){
          ...
          let url;
          if(volume){
            url ='/api/skbp1/getList?vol='+volume+'&prodi=hukum&type=skripsi';
          }else if(paginate){
            url =paginate;
          }else{
            url ='/api/skbp1/getList?prodi=hukum&type=skripsi';
          }
...
function searchJurnal(search){
  fetch(`/api/skbp1/search?prodi=hukum&type=skripsi&search=${search}`)
