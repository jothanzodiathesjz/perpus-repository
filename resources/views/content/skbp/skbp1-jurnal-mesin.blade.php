...
<!-- E-commerce Search Bar Ends -->
  ...
  <div class="col-12">
    <div class="card invoice-preview-card">
      <div class="card-body">
        <h3 id="buletin-title">Buletin Teknik Mesin: Recent Submssion</h3>
...
const url = '/api/skbp1/getvolume?prodi=Teknik Mesin&type=Jurnal';
...
getVolume()
        ...
        function getListFromVolume(volume,paginate){
          ...
          let url;
          if(volume){
            url ='/api/skbp1/getList?vol='+volume+'&prodi=Teknik Mesin&type=jurnal';
          }else if(paginate){
            url =paginate;
          }else{
            url ='/api/skbp1/getList?prodi=Teknik Mesin&type=jurnal';
          }
...
function searchJurnal(search){
  fetch(`/api/skbp1/search?prodi=Teknik Mesin&type=Jurnal&search=${search}`)
