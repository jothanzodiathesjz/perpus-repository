            ...
            <form id="multiStepsForm" onSubmit="return false">
              ...
              <div id="personalInfoValidation" class="content">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                    <label class="form-label" for="stambuk">NIDN</label>
                    <input type="text" id="stambuk" name="stambuk" class="form-control multi-steps-pincode" placeholder="Masukkan NIDN " maxlength="20" />
                  </div>
                  <div class="col-md-6">
